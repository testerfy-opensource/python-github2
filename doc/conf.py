# -*- coding: utf-8 -*-
#
# python-github3 documentation build configuration file, created by
...
version = ".".join(map(str, github3.VERSION[:2]))
# The full version, including alpha/beta/rc tags.
release = github3.__version__
...
latex_documents = [
  ('index', 'github3.tex', u'github3 Documentation',
   u'Ask Solem', 'manual'),
]
...
man_pages = [
    ('index', 'github3', u'github3 Documentation',
     [u'Ask Solem'], 1)
]
